...
// The @JvmOverload annotation instructs the Kotlin compiler to generate overloads for this
...
class ClippedView @JvmOverloads constructor(
    ...
    override fun onDraw(canvas: Canvas?) {
        super.onDraw(canvas)
        canvas?.let {
            drawBackAndUnclippedRectangle(it)
            drawDifferenceClippingExample(it)
            drawCircularClippingExample(it)
            drawIntersectionClippingExample(it)
            drawCombinedClippingExample(it)
            drawRoundedRectangleClippingExample(it)
            drawOutsideClippingExample(it)
            drawSkewedTextExample(it)
            drawTranslatedTextExample(it)
            drawQuickRejectExample(it)
        }
    }
